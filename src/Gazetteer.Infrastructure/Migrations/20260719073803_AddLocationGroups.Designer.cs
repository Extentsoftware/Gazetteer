...
namespace Gazetteer.Infrastructure.Migrations
{
    ...
    [Migration("20260719073803_AddLocationGroups")]
            ...
            modelBuilder.Entity("Gazetteer.Core.Models.Country", b =>
                {
                    ...
                    b.Property<DateTime?>("LastSeededAtUtc")
                        ...
                        .HasColumnName("last_seeded_at_utc");

                    b.Property<DateTime?>("LastSeededFileTimestampUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_seeded_file_timestamp_utc");
