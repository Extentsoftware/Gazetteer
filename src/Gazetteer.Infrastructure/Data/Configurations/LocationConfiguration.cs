...
public class LocationConfiguration : IEntityTypeConfiguration<Location>
{
    public void Configure(EntityTypeBuilder<Location> builder)
    {
        ...
        builder.Property(l => l.OsmType).HasColumnName("osm_type");
        builder.Property(l => l.Name).HasColumnName("name").HasMaxLength(500);
        ...
        builder.Property(l => l.AlternateNames).HasColumnName("alternate_names");
        builder.Property(l => l.LocationType).HasColumnName("location_type");
        builder.Property(l => l.CountryCode).HasColumnName("country_code").HasMaxLength(2);
        builder.Property(l => l.Lat).HasColumnName("lat");
        builder.Property(l => l.Lon).HasColumnName("lon");
        ...
        builder.Property(l => l.PostalCode).HasColumnName("postal_code").HasMaxLength(20);
